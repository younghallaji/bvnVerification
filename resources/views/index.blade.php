...
<section class="bg-gray-50 min-h-screen flex items-center justify-center">
  <div class="bg-gray-100 flex rounded-2xl p-5 shadow-lg max-w-3x1">
      <div class="sm:w-1/2 items-center px-16">
          <h2 class="font-bold text-6xl text-center pt-8 pb-3 text-[#9578EF]">Login</h2>
          <p class="text-sm text-center mt-4">If you a new member, please 
            <a href="{{route('register')}}" class="font-semibold text-[#9578EF] hover:text-[#b684f3cf]">Sign Up</a>
          </p>
            ...
            @csrf
              ...
              <div>
                <div class="flex items-center justify-between">
                  ...
                  <div class="text-sm">
                    <a href="#" class="font-semibold text-[#9578EF] hover:text-[#b684f3cf]">Forgot password?</a>
                  </div>
                </div>
              ...
              @enderror
              <div>
                <button type="submit" class="flex w-full justify-center rounded-md bg-[#9578EF] px-3 py-1.5 text-lg font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Sign in</button>
              </div>
            </form>
      </div>
